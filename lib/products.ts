...
export const PRODUCTS: Product[] = [
  {
    ...
    about: "We grow a wild ginger-bug culture from fresh ginger. Bangkok's heat means it's ready in about 4 days. We pitch it into a strong ginger tea and let it ferment until the character is right. Then we pasteurize, sweeten with erythritol, add fresh lime, force-carbonate, and bottle.",
    ingredients: "Fresh ginger, erythritol, filtered water, lime, ginger-bug culture.",
    process: "Wild ferment · ~4 days",
