...
export function AdminOrders() {
  ...
  const [filter, setFilter] = useState<"all" | "stripe" | "cod" | "subs">("all");
  ...
  const filtered = orders.filter(o => {
    ...
    if (filter === "cod") return o.method === "cod";
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 13, color: "rgba(44,24,16,0.65)", marginTop: 4 }}>
                      {o.email ?? "—"} · <span style={{ textTransform: "uppercase", fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", color: o.method === "cod" ? "#8B3A1A" : "#4A7C3F" }}>{o.method ?? "?"}</span>
