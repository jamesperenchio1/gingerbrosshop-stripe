  ...
  return (
    <InfoPage
      ...
      sections={[
        ...
        { h: "Is the Ginger Ale fermented too?", body: "No. The Ale is cooked ginger syrup blended with cold soda water — no fermentation, no alcohol, 0% ABV. Only the Beer is wild-fermented. The Shot is cold-pressed only." },
        { h: "What's the difference between the Beer and the Ale?", body: "Different drinks, different methods. The Beer is a 10–14 day wild ginger-bug ferment — bold, ginger-forward, full carbonation. The Ale is ginger syrup blended with soda water — lighter heat, brighter on the lime, easier with food or stretched with rum." },
