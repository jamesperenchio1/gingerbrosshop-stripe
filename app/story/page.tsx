  ...
  return (
    <InfoPage
      ...
      sections={[
        {
          h: "What we make",
          body: "One drink: Ginger Beer. The cocktail mixer / Friday-night drink / cold-with-food drink. Bold, ginger-forward, fully carbonated, 0g residual sugar. We wanted to make this one thing really well rather than spread thin across a range.",
        },
        {
          h: "How it's made",
