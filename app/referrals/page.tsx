...
export default function ReferralsPage() {
  return (
    <InfoPage
      ...
      sections={[
        { h: "How it works (coming soon)", body: "We're building the referral system right now. In the meantime, share your favorite brew with a friend and email us — we'll credit your account manually." },
